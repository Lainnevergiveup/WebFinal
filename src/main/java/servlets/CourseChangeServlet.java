...
@WebServlet(name = "CourseChangeServlet", value = "/courseChange.do")
...
//        request.getRequestDispatcher("./jspFiles/superMonitorMain.jsp").forward(request,response);
    ...
    protected void doDelete(HttpServletRequest request, HttpServletResponse response){
        ...
        courseUtil.deleteCourse(id);
        scUtil.deleteCourse(id);
        tcUtil.deleteCourse(id);
    }
    protected void doUpdate(HttpServletRequest request, HttpServletResponse response){
        Course t = new Course(request.getParameter("id"),request.getParameter("name"),
                request.getParameter("description"),Float.parseFloat(request.getParameter("score")));
        courseUtil.updateCourse(t);
    ...
    protected void doInsert(HttpServletRequest request, HttpServletResponse response){
        Course t = new Course(request.getParameter("id"),request.getParameter("name"),
                request.getParameter("description"),Float.parseFloat(request.getParameter("score")));
        courseUtil.insertCourse(t);
        tcUtil.insertCourse(t.getId());
