        ...
        <div class="row" style="height: 100%">
            <div class="col-3 col-md-2" style="">
                <ul class="nav nav-pills flex-column">
                    <li class="nav-item"> <a href="" class="active nav-link" data-toggle="pill" data-target="#questionList">提问列表</a> </li>
<%--                    <li class="nav-item"> <a href="./jspFiles/studentAskQuestion.jsp" class="active nav-link" data-toggle="pill" data-target="#questionList">我要提问</a> </li>--%>
                </ul>
            </div>
                        ...
                        <c:forEach items="${questionList}" var="q">
                            <div class="card" >
                                <div class="card-body">
                                    ...
                                    <a href="./questionDetail.do?qid=${q.id}" class="card-link">查看详情</a>
                                    <a href="./deletequestion.do?qid=${q.id}" class="card-link">删除</a>
                                </div>
                            </div>
                        </c:forEach>

                        <a class="btn-primary" href="./jspFiles/studentAskQuestion.jsp" type="submit"  value="发起提问" id="ask">发起提问</a>
