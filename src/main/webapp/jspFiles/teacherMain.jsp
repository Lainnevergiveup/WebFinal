        ...
        <div class="row" style="height: 100%">
            <div class="col-3 col-md-2" style="">
                <ul class="nav nav-pills flex-column">
                    <li class="nav-item"> <a href="" class="active nav-link" data-toggle="pill" data-target="#courseList">课程列表</a> </li>
            ...
            <div class="col-9 col-md-10 h-100 w-100" style="height: 100%">
                <div class="tab-content">
                    <div class="tab-pane fade show active h-100" id="courseList" role="tabpanel" height="100%">
